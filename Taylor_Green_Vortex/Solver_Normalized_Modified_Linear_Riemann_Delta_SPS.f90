...
!****************************************************************************
 ...
 subroutine Solver_Normalized_Modified_Linear_Riemann_Delta_SPS()
    ...
    do k=1,pair_number
        ...
        do L=1,dim
            average_velocity(i,L)=average_velocity(i,L)-epsilon*2*subdomain_particle_mass(j)*velocity_difference(L)/(subdomain_particle_rho(i)+subdomain_particle_rho(j))*w(k)
            average_velocity(j,L)=average_velocity(j,L)+epsilon*2*subdomain_particle_mass(i)*velocity_difference(L)/(subdomain_particle_rho(i)+subdomain_particle_rho(j))*w(k)                  
        end do
 ...
 end subroutine Solver_Normalized_Modified_Linear_Riemann_Delta_SPS