...
subroutine MLS_Interpolation_In_Gobal_Domain(MLSOrder,Interpolate_particle_position,ture_effect_number,ture_effect_name,W_kernel,Fai)
    ...
    if(MLSOrder==2) then
        ...
        do k=1,ture_effect_number
            ...
            position_difference(:)=Interpolate_particle_position(:)-particle_position(j,:)
        ...
        do k=1,ture_effect_number
            ...
            if(MLSOrder==1) then
                ...
                P(2,k)=(particle_position(j,1)-Interpolate_particle_position(1))/smooth_length
                P(3,k)=(particle_position(j,2)-Interpolate_particle_position(2))/smooth_length
                P(4,k)=((particle_position(j,1)-Interpolate_particle_position(1))/smooth_length)**2
                P(5,k)=(particle_position(j,1)-Interpolate_particle_position(1))/smooth_length*(particle_position(j,2)-Interpolate_particle_position(2))/smooth_length
                P(6,k)=((particle_position(j,2)-Interpolate_particle_position(2))/smooth_length)**2
        ...
        if(MLSOrder==6 .and. ture_effect_number<=10) then
