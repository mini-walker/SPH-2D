...
subroutine   status_equation(particle_rho,&                 !particle density
    ...
    !Water EOS
        ...
        particle_press=b*((particle_rho/water_rho_0)**7-1.0)                                         
        ...
        ! ------------------------------------------------------------------------
        ! particle_press=square_c_0*(particle_rho-water_rho_0)                                           
        ! particle_c=sqrt(square_c_0)*(particle_rho/water_rho_0)**3
        ...
        ! ------------------------------------------------------------------------
        ! particle_press=square_c_0*(1+cap_gamma*(particle_energy/e_0-1.0))*(particle_rho-water_rho_0) !2nd order EOS
