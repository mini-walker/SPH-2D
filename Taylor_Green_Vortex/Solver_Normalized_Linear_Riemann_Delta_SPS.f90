...
!
!  SUBROUTINE: Solver_Normalized_Modified_Riemann_Delta_SPS
!
...
!****************************************************************************
 ...
 subroutine Solver_Normalized_Linear_Riemann_Delta_SPS()
    ...
    do k=1,pair_number
        ...
        U_asterisk=subdomain_particle_rho(i)*subdomain_particle_c(i)*U_Right+subdomain_particle_rho(j)*subdomain_particle_c(j)*U_Left+P_Left-P_Right
        U_asterisk=U_asterisk/(subdomain_particle_rho(i)*subdomain_particle_c(i)+subdomain_particle_rho(j)*subdomain_particle_c(j))

        velocity_asterisk=U_asterisk*IJ_Direction_Vector

        ! Belta_Riemman=min(3.0*(max((U_Left-U_Right),0.0d0)),sqrt(square_c_0))
        ! P_asterisk=P_Bar+0.5*Belta_Riemman*average_rho*(U_Left-U_Right)

        P_asterisk=subdomain_particle_rho(i)*subdomain_particle_c(i)*P_Right+subdomain_particle_rho(j)*subdomain_particle_c(j)*P_Left+subdomain_particle_rho(i)*subdomain_particle_c(i)*subdomain_particle_rho(j)*subdomain_particle_c(j)*(U_Left-U_Right)
        P_asterisk=P_asterisk/(subdomain_particle_rho(i)*subdomain_particle_c(i)+subdomain_particle_rho(j)*subdomain_particle_c(j))
 ...
 end subroutine Solver_Normalized_Linear_Riemann_Delta_SPS