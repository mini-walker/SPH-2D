...
!****************************************************************************
 ...
 subroutine Solver_Normalized_MUSCL_Linear_Riemann_Delta()
    ...
    do k=1,pair_number
       ...
       !--------------------------------------------------------------------------------------
       !Notice: The test show that the gradience from j minus i is more accuracy

       !Gradience from j minus i
       !velocity difference
       ...
       ! !--------------------------------------------------------------------------------------
       ! !Gradience from j plus i
       ! !velocity difference
       ! velocity_difference(:)=subdomain_particle_velocity(i,:)+subdomain_particle_velocity(j,:)     !Attention: j+i
 ...
 end subroutine Solver_Normalized_MUSCL_Linear_Riemann_Delta