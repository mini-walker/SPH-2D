...
!
!  SUBROUTINE: Solver_Normalized_Standard_SPH
!
!  PURPOSE: Compute iterator information for time integration with Normalized kernel function
!
...
!****************************************************************************
 ...
 end subroutine Solver_Normalized_Standard_SPH