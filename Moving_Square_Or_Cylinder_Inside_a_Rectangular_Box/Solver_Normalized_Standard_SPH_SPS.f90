...
!
!  SUBROUTINE: Solver_Normalized_Standard_SPH_SPS
!
!  PURPOSE: Compute iterator information for time integration with Normalized kernel function and SPS
!
...
!****************************************************************************
 ...
 end subroutine Solver_Normalized_Standard_SPH_SPS